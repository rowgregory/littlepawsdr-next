export const oneTimedonationConfirmationTemplate = (donorName: string, amount: number, orderId: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Donation Confirmation - Education Comes First</title>
</head>
  ...
  <div style="max-width: 500px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 48px; padding: 24px; background-color: #ffffff; border: 1px solid #f0e6db; border-radius: 6px;">
      ...
      <div style="margin-bottom: 0; padding-top: 16px; border-top: 1px solid #f0e6db;">
        <p style="margin: 0 0 8px 0; color: #00a2d1; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Date</p>
    ...
    <div style="margin-bottom: 48px; padding: 24px; background-color: #fddd58; border-radius: 6px;">
      <p style="margin: 0; color: #000000; font-size: 14px; line-height: 1.8; font-weight: 500;">
        Your donation directly supports educational programs, mentorship, and community initiatives that empower students to reach their full potential. Thank you for making a difference!
      </p>
    </div>
    ...
    <div style="margin-bottom: 48px;">
      <p style="margin: 0; color: #666666; font-size: 13px; line-height: 1.6;">
        <strong style="color: #1a1a1a;">Tax Information:</strong> Education Comes First is a 501(c)(3) nonprofit organization. Your donation is tax-deductible to the extent allowed by law.
      </p>
    </div>
