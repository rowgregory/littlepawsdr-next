export const productConfirmationTemplate = (customerName: string, amount: number, orderId: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Order Confirmed - Little Paws Dachshund Rescue</title>
  <style>
...
<body style="margin: 0; padding: 0; background: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 540px; margin: 0 auto; padding: 56px 24px;">
    ...
    <p class="main-text" style="margin: 0 0 36px 0; color: #71717a; font-size: 15px; line-height: 1.7;">
      Thank you for your purchase. Every order directly supports the dachshunds in our care. We'll be in touch with shipping details if applicable.
    </p>
    ...
    <div style="margin-bottom: 36px;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        <tr>
          <td style="padding: 12px 0; border-bottom: 1px solid #e4e4e7; color: #71717a; font-size: 14px;">Order Total</td>
        ...
        <tr>
          <td style="padding: 12px 0; color: #71717a; font-size: 14px;">Order ID</td>
    ...
    <div style="margin-bottom: 40px; padding: 16px; background: #f4f4f5; border: 1px solid #e4e4e7; border-left: 3px solid #0891b2;">
      <p style="margin: 0; color: #71717a; font-size: 13px; line-height: 1.7;">
        <strong style="color: #09090b;">Shipping info</strong><br>
        If your order includes physical items, we'll send a separate email with tracking information once your order ships.
      </p>
    </div>
