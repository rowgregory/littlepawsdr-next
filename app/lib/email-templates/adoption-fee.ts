export const adoptionFeeConfirmationTemplate = (customerName: string, amount: number, orderId: string) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Adoption Fee Received - Little Paws Dachshund Rescue</title>
  <style>
...
<body style="margin: 0; padding: 0; background: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 540px; margin: 0 auto; padding: 56px 24px;">
    ...
    <h1 class="main-heading" style="margin: 0 0 12px 0; color: #09090b; font-size: 26px; font-weight: 900; line-height: 1.2;">
      Adoption fee received, ${customerName}!
    </h1>
 
    <!-- Body text -->
    <p class="main-text" style="margin: 0 0 36px 0; color: #71717a; font-size: 15px; line-height: 1.7;">
      We've received your adoption application fee. Our team will review your application and be in touch within 3–5 business days. We're so excited to help you find your perfect dachshund match!
    </p>
    ...
    <div style="margin-bottom: 36px;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        <tr>
          <td style="padding: 12px 0; border-bottom: 1px solid #e4e4e7; color: #71717a; font-size: 14px;">Application Fee</td>
    ...
    <div style="margin-bottom: 40px; padding: 16px; background: #f4f4f5; border: 1px solid #e4e4e7; border-left: 3px solid #0891b2;">
      <p style="margin: 0; color: #71717a; font-size: 13px; line-height: 1.7;">
        ...
        Our adoption team will review your application and reach out within 3–5 business days to discuss the next steps. In the meantime, feel free to browse our available dogs at <a href="https://www.littlepawsdr.org/dogs" style="color: #0891b2; text-decoration: none;">littlepawsdr.org/dogs</a>.
      </p>
    </div>
