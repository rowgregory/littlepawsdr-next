  ...
  <div style="max-width: 540px; margin: 0 auto; padding: 56px 24px;">
    ...
    <div style="margin-bottom: 36px;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        <tr>
          <td style="padding: 12px 0; border-bottom: 1px solid #e4e4e7; color: #52525b; font-size: 14px;">
            Your bid
          </td>
          <td
            style="padding: 12px 0; border-bottom: 1px solid #e4e4e7; color: #52525b; font-size: 14px; text-align: right; font-family: 'Courier New', monospace; text-decoration: line-through;"
            aria-label="Your previous bid: $${yourBid.toLocaleString()}"
          >
        ...
        <tr>
          ...
          <td style="padding: 12px 0; border-bottom: 1px solid #e4e4e7; color: #b91c1c; font-size: 14px; text-align: right; font-family: 'Courier New', monospace; font-weight: 700;">
