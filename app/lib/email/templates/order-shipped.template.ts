        ...
        <tr>
          ...
          ${
            item.quantity && item.quantity > 1
              ? `
          <td style="padding: 12px 0; ${i < items.length - 1 ? 'border-bottom: 1px solid #e4e4e7;' : ''} color: #52525b; font-size: 14px; text-align: right; font-family: 'Courier New', monospace;">
            x${item.quantity}
          </td>`
              : '<td></td>'
          }
