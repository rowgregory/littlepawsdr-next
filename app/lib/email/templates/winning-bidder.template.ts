...
<body style="margin: 0; padding: 0; background: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 540px; margin: 0 auto; padding: 56px 24px;">
    ...
    <div style="margin-bottom: 24px; display: inline-block; padding: 6px 14px; background: #0891b2; ">
      <p style="margin: 0; color: #ffffff; font-size: 9px; font-family: 'Courier New', monospace; letter-spacing: 0.25em; text-transform: uppercase; font-weight: 700;">
         &nbsp;Auction Winner
      </p>
    </div>
    ...
    <div style="margin-bottom: 16px;">
      <a href="${url}" class="button" style="display: inline-block; background: #0891b2; color: #ffffff; text-decoration: none; padding: 16px 40px; font-weight: 700; font-size: 11px; font-family: 'Courier New', monospace; letter-spacing: 0.2em; text-transform: uppercase;">
        Complete your payment →
      </a>
    </div>
    <p style="margin: 0 0 40px 0; color: #a1a1aa; font-size: 12px; font-family: 'Courier New', monospace;">
      Or copy this link: <a href="${url}" style="color: #0891b2; text-decoration: none;">${url}</a>
    </p>
    ...
    <div style="margin-bottom: 40px; padding: 16px; background: #f4f4f5; border: 1px solid #e4e4e7; border-left: 3px solid #0891b2;">
      <p style="margin: 0; color: #71717a; font-size: 13px; line-height: 1.7;">
        <strong style="color: #09090b;"48-hour payment window</strong><br>
