...
const DogsOnHold = () => {
  ...
  return (
    <div className="mb-40">
      <Hero bgImg="/images/hold.jpg" title="Not Available For Adoption Yet" breadcrumb="Dogs on Hold" className="bg-[0_45%]" />
      <div className="max-w-[1150px] mx-auto pt-32">
        ...
        <div className="mb-32">
          ...
          <div className="mb-4 max-w-prose">
            <p className="mb-4">
              In addition to our Dogs Available for Adoption page, we’re also sharing our dogs in foster homes being evaluated for future adoptions.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Please continue to watch our Available Dogs page to see when a dog you may be interested in is ready for his or her forever home. That’s
              when we’ll be happy to accept an application from you.
            </p>
          </div>
        </div>
