  ...
  return (
    <div className="mb-40">
      ...
      <div className="max-w-[1150px] mx-auto w-full mt-20">
        <p className="text-teal-400 text-xl font-QBold mb-5 text-center">
          Meet The Animals
        </p>
        <p className="text-5xl text-color font-QBold mb-5 text-center">
          Waiting For Adoption
        </p>
        <p className="text-color font-QLight text-center mb-10">
          We are excited that you are interested in adding a dachshund <br /> or
          dachshund-mix to your family!
        </p>
