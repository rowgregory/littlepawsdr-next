  ...
  return (
    ...
    >
      <div className="flex items-baseline gap-4 mb-4">
        <span className="font-mono text-[10px] tracking-[0.2em] text-primary-light dark:text-primary-dark shrink-0">
          {number}
        </span>
        <h2
          id={`section-${number}`}
    ...
    <ul className="space-y-2" role="list">
      {items.map((item, i) => (
        <li key={i} className="flex items-start gap-3">
          <span
            className="mt-1.75 w-1 h-1 bg-primary-light dark:bg-primary-dark shrink-0"
            aria-hidden="true"
          />
          <span>{item}</span>
        </li>
  ...
  return (
    <main id="main-content" className="bg-bg-light dark:bg-bg-dark min-h-screen">
      ...
      >
        ...
        {/* Accent */}
        <div
          className="absolute top-0 left-0 w-1 h-20 bg-primary-light dark:bg-primary-dark"
          aria-hidden="true"
        />
        ...
        <div className="max-w-4xl mx-auto px-4 xs:px-5 sm:px-6 py-14 sm:py-20">
          ...
          >
            <p className="font-mono text-[11px] tracking-widest text-muted-light dark:text-muted-dark">
      ...
      <div className="max-w-4xl mx-auto px-4 xs:px-5 sm:px-6 py-10 sm:py-14 space-y-10 sm:space-y-12">
        ...
        >
          <p className="font-nunito text-sm sm:text-[15px] text-text-light dark:text-text-dark leading-relaxed">
            Little Paws Dachshund Rescue (&quot;Little Paws,&quot; &quot;we,&quot; &quot;us,&quot;
            or &quot;our&quot;) is a volunteer-run 501(c)(3) nonprofit dedicated to rescuing,
            rehabilitating, and rehoming dachshunds and dachshund mixes. This Privacy Policy
          ...
          <p className="font-nunito text-sm sm:text-[15px] text-muted-light dark:text-muted-dark leading-relaxed mt-3">
            By using our platform you agree to the practices described in this policy. If you do not
        ...
        <Section number="01" title="Information We Collect">
          ...
          <SubSection title="Payment Information">
            <p>
              ...
              We do not store your raw credit card numbers, CVV codes, or full card details on our
              servers. What we store is limited to:
            </p>
            <BulletList
              items={[
            ...
            <Muted>
              If you enable auto-pay for auctions, your saved payment method will be charged
              automatically if you win an item, without any further action from you. You can enable
              or disable auto-pay at any time in your account settings.
            </Muted>
          </SubSection>
          ...
          <SubSection title="Transaction & Activity Data">
            ...
            />
            <Muted>
              You may enable anonymous bidding in your account settings to hide your name from other
              bidders during auctions. This setting does not affect our own records — your identity
              remains associated with your bids for administrative purposes.
            </Muted>
          </SubSection>

          <SubSection title="Authentication Data">
            <p>
              We use NextAuth.js to manage authentication. When you sign in, we create a session
              record in our database and issue a secure, HttpOnly cookie containing a session token
              that references it. This cookie does not itself contain your personal information — it
              is simply a reference our servers use to look up your active session. Sessions expire
              automatically and are removed when you sign out.
            </p>
            <p>
              We offer three ways to sign in. If you sign in via Google or Facebook, we receive your
              name and email address from that provider. We do not receive your password or any
              other account data beyond what is needed to identify you. If you sign in via a magic
              link, we send a one-time link to your email address that signs you in automatically
              when clicked — no password is ever created or stored.
            </p>
          </SubSection>

          <SubSection title="Communication Preferences">
            <p>
              If you opt in to our newsletter or email communications, we store your email address
              and subscription preferences so we can send you updates about dogs, events, and
          ...
          <SubSection title="Automatically Collected Data">
            ...
            />
            <Muted>
              This data is used for security and performance monitoring. It is not sold or used for
              advertising.
            </Muted>
          </SubSection>
          ...
          <SubSection title="Analytics">
            <p>
              We use Google Analytics to understand how visitors use our site — which pages are
              viewed, how long visitors stay, and general geographic and device information. We do
              not use this data to identify individual visitors, and we do not combine it with your
              account information.
            </p>
            <Muted>
              Google&apos;s use of this data is governed by the Google Privacy Policy at
        ...
        <Section number="03" title="How We Use Your Information">
          ...
          />
          <Muted>
            We do not use your personal information for advertising, sell it to data brokers, or
            share it with third parties for their marketing purposes.
          </Muted>
        </Section>
        ...
        <Section number="04" title="How We Share Your Information">
          <SubSection title="Service Providers">
            <p>
              We share data with a limited set of trusted service providers who help us operate our
              platform. Each provider processes data only as necessary to perform their service:
            </p>
            <BulletList
              items={[
          ...
          <SubSection title="Legal Requirements">
            <p>
              ...
              legal process such as a subpoena, court order, or government request. We may also
              disclose information where we believe in good faith that disclosure is necessary to
          ...
          <SubSection title="Organizational Transfers">
            <p>
              In the unlikely event of a merger, acquisition, or transfer of assets, your
        ...
        <Section number="05" title="Cookies & Local Storage">
          ...
          />
          <p>
            We do not use advertising cookies or third-party tracking cookies for marketing
            purposes. You can clear cookies at any time through your browser settings, but doing so
            will sign you out of our platform.
          </p>
        </Section>
        ...
        <Section number="06" title="Data Retention">
          ...
          <p>
            ...
            information within 30 days, except where retention is required by law or for legitimate
            business purposes such as fraud prevention or pending disputes.
          </p>
        </Section>
        ...
        <Section number="07" title="Your Rights & Choices">
          ...
          />
          <Muted>
            To exercise any of these rights, please contact us using the information below. We will
        ...
        <Section number="09" title="Third-Party Links">
          <p>
            Our platform may contain links to third-party websites such as Rescue Groups, Give
            Lively, and event ticketing platforms. This Privacy Policy does not apply to those
            sites. We encourage you to review the privacy policies of any third-party services you
            use.
          </p>
        </Section>
        ...
        <Section number="10" title="Children's Privacy">
          <p>
            Our platform is not directed at children under the age of 13, and we do not knowingly
        ...
        <Section number="11" title="Changes to This Policy">
          <p>
            ...
            effective date at the top of this document and, for material changes, notify registered
            users by email. Your continued use of our platform after changes take effect constitutes
        ...
        <Section number="12" title="Contact Us">
          ...
          <div className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark p-5">
            <p className="font-quicksand font-bold text-text-light dark:text-text-dark mb-2">
          ...
          <Muted>
            We are a volunteer-run organization and will do our best to respond to all inquiries
