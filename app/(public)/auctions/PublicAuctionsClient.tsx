        ...
        <div className="relative aspect-4/3 lg:aspect-auto lg:min-h-100 overflow-hidden bg-surface-light dark:bg-surface-dark">
          <div className="absolute inset-0 flex items-center justify-center bg-surface-light dark:bg-surface-dark overflow-hidden">
            ...
            <div className="relative flex flex-col items-center gap-4">
              ...
              <span className="text-[8px] font-mono tracking-[0.5em] uppercase text-muted-light/30 dark:text-muted-dark/30">
                {auction.title}
              </span>
            </div>
            {/* Corner accents */}
            <div
              className="absolute top-4 left-4 w-6 h-6 border-t border-l border-primary-light/30 dark:border-primary-dark/30"
              aria-hidden="true"
            />
            <div
