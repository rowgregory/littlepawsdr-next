          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-muted-light dark:text-muted-dark leading-relaxed">
                Little Paws Dachshund Rescue is a volunteer-run nonprofit dedicated to saving dachshunds and dachshund
                mixes from shelters, surrenders, and neglect — giving every long dog a second chance at a loving forever
                home.
              </p>
            </div>
              ...
              <dl className="space-y-5">
                {[
                  ...
                  <div key={stat} className="flex items-baseline gap-4">
                    <dt className="font-quicksand font-black text-2xl te  xt-primary-light dark:text-primary-dark tabular-nums shrink-0">
                      {stat}
                    </dt>
